	...
	<div class="span-20 last customAccount">
		<cms:pageSlot position="TopContent" var="feature" element="div" class="span-20 wide-content-slot cms_disp-img_slot">
			<cms:component component="${feature}"/>
				...
				<div class="tile column WishlistDetails">
					<c:url value="/wishlist/modify/" var="addToWishlistUrl"/>
					<div class="headline"><a href="${addToWishlistUrl}"><spring:theme text="Wishlist"/></a></div>
					<ul>
						<ycommerce:testId code="myAccount_options_wishlist_groupbox">
							<li><a href="${addToWishlistUrl}"><spring:theme text="View Wishlist"/></a></li>
						</ycommerce:testId>
					</ul>
				</div>
